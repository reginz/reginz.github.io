            ...
            <div className="hero-container">
                    ...
                    <div className="hero-banner">
                        ...
                        <div className="paragraph">
                            ...
                            Our quest is to build the ultimate intelligent agent. 
                            Intelligent agents are software entities where we put 
                            AI into action. An ultimate intelligent agent can collaborate
                             without us noticing, build without instructions and
                              carry all human knowledge
                            </p>
